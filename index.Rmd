...
-   [Metodología híbrida para el abordaje de la extracción de patrones en videos usando CCN y RNN](https://cschenone.github.io/docs/desarrollo/analisis-videos/Metodolog%C3%ADa-h%C3%ADbrida-para-el-abordaje-de-la-extracci%C3%B3n-de-patrones-en-videos-usando-CCN-y-RNN.html)
...
-   [Metodología híbrida para el análisis de un corpus de artículos académicos](https://cschenone.github.io/docs/desarrollo/analisis-corpus/Metodolog%C3%ADa-h%C3%ADbrida-para-al-an%C3%A1lisis-de-un-corpus-de-art%C3%ADculos-acad%C3%A9micos.html)
    ...
    -   [Próximos pasos](https://cschenone.github.io/docs/desarrollo/analisis-corpus/Proximos-pasos.html): El documento contiene las directrices y los siguientes pasos para el desarrollo del artículo donde se presenten los resultados del proyecto.

### Investigación - Research

-   [Metodogía híbrida para la detección de Cianobacterias](https://cschenone.github.io/docs/investigacion/cianobacterias/Cianobacterias.html)
...
-   [Metodología híbrida para la detección de Plagas y Malezas](https://cschenone.github.io/docs/investigacion/plagasymalezas/PlagasyMalezas.html)
...
-   [Conceptos de Inteligencia Artificial](https://cschenone.github.io/docs/genericos/conceptos_de_ia.html)

    Documento para realizar la puesta en común de temas sobre Inteligencia Artificial

-   [Ïndice de bases de datos indexadas abiertas](https://cschenone.github.io/docs/genericos/Indice-de-Base-de-Datos-indexadas-Abiertas.html)

    Enlaces que podrían ser útiles para acceder a las bases de datos de Rusia, China y Catálogos de trabajos científicos como OpenAlex.

-   [Buenas prácticas en GitHub](https://cschenone.github.io/docs/genericos/Recomendaciones_para_trabajar_en_Git.html)

    Armamos el documento pensando que sería de utilidad presentarle algunas recomendaciones para utilizar la herramienta.
...
-   [CEGELAH/FCyT/UADER - Centro para la Gestión Local Sostenible del Agua y el Hábitat Humano](https://cegelah.fcyt.uader.edu.ar/)
